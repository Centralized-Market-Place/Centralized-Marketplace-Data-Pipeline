...
MONGO_URI2 = "mongodb+srv://milliontolessa:mRZA8ra4IQmudFuQ@products.6xxlile.mongodb.net/?retryWrites=true&w=majority&appName=products"
DB_NAME2 = "fyp-search"
# TARGET_COLLECTION_NAME = "structured"
target_db = MongoClient(MONGO_URI2)[DB_NAME2]
structured = target_db["structured_products"]
